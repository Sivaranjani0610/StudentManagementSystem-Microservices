This is the Microservices Spring Boot Project for Student Management System. The rest API and Java is used. The REST API operations can be done using Postman Tool.
